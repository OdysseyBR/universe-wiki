...
import { startFocusLogin } from '../lib/focusOAuth'
...
function FocusIcon() {
  // Reproduz o ícone de 4 blocos do Focus Account em SVG estático, no mesmo
  // espírito dos ícones de Google/GitHub acima — sem depender de CSS externo.
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <rect x="2" y="2" width="9.5" height="9.5" rx="2.5" fill="#F5B800" />
      <rect x="12.5" y="2" width="9.5" height="9.5" rx="2.5" fill="#E5231B" />
      <rect x="2" y="12.5" width="9.5" height="9.5" rx="2.5" fill="#0FB95C" />
      <rect x="12.5" y="12.5" width="9.5" height="9.5" rx="2.5" fill="#1C6FE8" />
    </svg>
  )
}
    ...
    <div className="min-h-screen bg-wiki-bg-main flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="border border-wiki-border bg-white p-5 space-y-2">
          ...
          <button onClick={startFocusLogin}
            className="w-full flex items-center justify-center gap-2 border border-wiki-border hover:bg-wiki-bg-sidebar text-wiki-text text-sm px-4 py-2.5 transition-colors">
            <FocusIcon /> Entrar com Focus
          </button>
        </div>
