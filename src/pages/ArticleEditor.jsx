      ...
      {preview ? (
        <div className="relative rounded-xl overflow-hidden border border-ink-700/50 bg-ink-900">
          ...
          <button
            type="button"
            onClick={onRemove}
            className="absolute top-2 right-2 w-7 h-7 bg-ink-950/80 hover:bg-red-600/80 rounded-full flex items-center justify-center transition-colors"
          >
